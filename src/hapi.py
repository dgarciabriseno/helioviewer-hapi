...
def get_data(dataset: str, start: datetime, stop: datetime, parameters: list[str]) -> Result:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--parameters", required=True, type=str, help="Dataset specific parameters to return")
    parser.add_argument("--start", required=True, type=datetime.fromisoformat, help="Start of query range")
    parser.add_argument("--stop", required=True, type=datetime.fromisoformat, help="Stop of query range")
